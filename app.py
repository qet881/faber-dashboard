...
def mode_strategy_backtest(current_dt, current_date, price_col, bt_start_date):
    ...
    # ==============================
    # 슬롯 교체 실험 (HYG/IEF/XLE/XLF/BRK-B) — expander
    # ==============================
    st.markdown("---")
    with st.expander("🔬 슬롯 교체 실험 (HYG / IEF / XLE / XLF / BRK-B) — 클릭하여 펼치기 (시간 소요)", expanded=False):
        # ==============================
    ...
    # ==============================
    # Faber A 룰 × 주식 슬롯 비교 (3×3) — expander
    # ==============================
    st.markdown("---")
    with st.expander("⚔️ Faber A 룰 × 주식 슬롯 비교 (Sortino 순위) — 클릭하여 펼치기 (시간 소요)", expanded=False):
        # ==============================
